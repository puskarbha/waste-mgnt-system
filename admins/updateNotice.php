...
<div class="row">
    ...
    <div class="col-9 mt-2">
      ...
      $post_id=$_GET['nid'];
      $post_query="SELECT * FROM notice where nid='$post_id' LIMIT 1";
    ...
    ?>
        <form action="./_updateNotice.php" method="POST" role="document" enctype="multipart/form-data">

            <div class="card">
                <div class="card-header">
                    <span class="h3">notice Entry</span>
                </div>
                <div class="card-body">
                    ...
                    ?>
                        <select name="category" class="form-control" required>
                            ...
                            <option value="<?= $catitem['cat_id']?>"
                                <?= $catitem['cat_id'] ==  $row['category']?'selected':''?>><?=$catitem['name']?>
                            </option>
                            <?php
                        }
                        ?>
                ...
                ?>
                    ...
                    <div class="mt-4">
                        ...
                        <textarea class="form-control" style="min-height:30vh" id="exampleFormControlTextarea1"
                            name="desc" rows="4" required><?= $row['description']?></textarea>
                    </div>

                    <div class="mt-4">
                        <label for="slug" class="form-label h5">Slug</label>
                        <input type="text" id="slug" class="form-control" name="slug" value="<?= $row['slug']?>"
                            required>
                    </div>
                    <div class="mt-4">
